...
public class JanelaAlterar extends JFrame {
	...
	public JanelaAlterar(Servico s, Janela SalvarAlt) {
		...
		btnCadastrar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				for (int i = 0; i == linha; i++) {
					...
					lista.setLocal(local);
					lista.setFuncionário_responsavel(Funcionário_responsavel);
					lista.setRestricao_idade(Restricao_idade);
					lista.setCapacidade_maxima(capacidade_maxima);
					lista.setCusto_servico(Custo_servico);
					lista.setEquipamentos_fornecidos(Equipamentos_fornecidos);
					lista.setNivel_dificuldade(Nivel_dificuldade);
					lista.setFuncionário_responsavel(Funcionário_responsavel);
					lista.setDuracao(duracao);
					lista.setVagas_restantes(vagas_restantes);
					lista.setFeedback(Feedback);
					lista.setVezes_reservado(vezes_reservado);]
		...
		lblCadastrarServios = new JLabel("Alterar Serviços");
		...
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup().addGap(64)
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_contentPane.createSequentialGroup().addGap(124)
												.addComponent(txtDescricao, GroupLayout.PREFERRED_SIZE, 361,
												...
												.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
														...
														.addComponent(txtHorario, GroupLayout.PREFERRED_SIZE, 139,
																GroupLayout.PREFERRED_SIZE)))
										.addGroup(gl_contentPane.createSequentialGroup().addGap(498).addComponent(
												lblNewLabel_12, GroupLayout.PREFERRED_SIZE, 154,
												GroupLayout.PREFERRED_SIZE))
										.addGroup(gl_contentPane.createSequentialGroup().addGap(622).addComponent(
												txtIdade, GroupLayout.PREFERRED_SIZE, 139, GroupLayout.PREFERRED_SIZE))
										.addGroup(gl_contentPane.createSequentialGroup().addGap(498)
												.addComponent(lblNewLabel_1, GroupLayout.PREFERRED_SIZE, 154,
														GroupLayout.PREFERRED_SIZE))
										.addGroup(gl_contentPane
												.createSequentialGroup().addGap(498).addComponent(lblNewLabel_4,
														GroupLayout.PREFERRED_SIZE, 154, GroupLayout.PREFERRED_SIZE))
										.addComponent(lblNewLabel, GroupLayout.PREFERRED_SIZE, 652,
												GroupLayout.PREFERRED_SIZE)))
						.addGroup(gl_contentPane.createSequentialGroup().addGap(64).addGroup(gl_contentPane
								.createParallelGroup(Alignment.LEADING)
								.addComponent(lblNewel_2, GroupLayout.PREFERRED_SIZE, 652, GroupLayout.PREFERRED_SIZE)
								.addGroup(gl_contentPane.createSequentialGroup().addGap(124).addComponent(txtLocal,
										GroupLayout.PREFERRED_SIZE, 637, GroupLayout.PREFERRED_SIZE))))
						.addGroup(gl_contentPane.createSequentialGroup().addGap(64).addGroup(gl_contentPane
								.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_contentPane.createSequentialGroup().addGap(124).addComponent(
										txtDificuldade, GroupLayout.PREFERRED_SIZE, 103, GroupLayout.PREFERRED_SIZE))
								.addGroup(gl_contentPane.createSequentialGroup().addGap(235).addComponent(
										lblNewLabel_13, GroupLayout.PREFERRED_SIZE, 417, GroupLayout.PREFERRED_SIZE))
								...
								.addGroup(gl_contentPane.createSequentialGroup().addGap(403).addComponent(
										txtVagasRestantes, GroupLayout.PREFERRED_SIZE, 123, GroupLayout.PREFERRED_SIZE))
								.addComponent(lblNewLabel_8, GroupLayout.PREFERRED_SIZE, 652,
										GroupLayout.PREFERRED_SIZE))
								.addGap(10).addComponent(txtCapacidade, GroupLayout.PREFERRED_SIZE, 99,
										GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_contentPane.createSequentialGroup().addGap(64).addGroup(gl_contentPane
								.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_contentPane.createSequentialGroup().addGap(246).addComponent(
										txtVezesReservado, GroupLayout.PREFERRED_SIZE, 175, GroupLayout.PREFERRED_SIZE))
								.addComponent(lblNewLabel_11, GroupLayout.PREFERRED_SIZE, 652,
										GroupLayout.PREFERRED_SIZE)
						...
						.addGroup(gl_contentPane.createSequentialGroup().addGap(64).addGroup(gl_contentPane
								.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_contentPane.createSequentialGroup().addGap(549).addComponent(
										txtEquipamentos, GroupLayout.PREFERRED_SIZE, 212, GroupLayout.PREFERRED_SIZE))
								...
								.addComponent(lblNewLabel_14, GroupLayout.PREFERRED_SIZE, 652,
										GroupLayout.PREFERRED_SIZE)
						...
						.addGroup(gl_contentPane.createSequentialGroup().addGap(306).addComponent(lblCadastrarServios,
